      ...
      <div className="report">
        ...
        <div className="report__mainDiv">
          ...
          <div className="report__user__overview">
            <span class="Pinga-Patient-ID-01">Pinga Patient ID: 06</span>
          ...
          <div class="Health-Journey-Plan-for-Ria-Kapoor">
            Health Journey Plan for Sakshi Gupta
          </div>
          {steps.map((data, i) => {
            console.log(data);
            return (
            ...
            <div className="health__assessment__heading">
              ...
              <div className="assessment__heading">
                ...
                <span class="Your-Pinga-sexual-and-intimate-health-SA-shows-you-have-irregular-periods-vaginal-burning-and-heavy">
                  ...
                  Sakshi, kudos at taking your overall health and wellness Pinga assessment. Great investment, we make noodles in less than 10 minutes.
                </span>
              </div>
            </div>
            <div className="assessment__desc__one">
              ...
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  ...
                  we recorded that you primarily have concerns in 3 dimensions of your health - Mental health, skin and appearance and natural circadian sleep cycle.  <br/><br/>

                  You face concerns around mental health which comes out as anxiousness, lack of getting proper and timely sleep, and <b>hormonal imbalance</b> or not following appropriate lifestyle, leads to <b>skin issues</b> that you’re facing. <br/><br/>

                  By the way, stress releases cortisol and creates a vicious cycle of hormonal imbalance leading to many conditions including digestive issues, skin issues, hair loss, brain fog and irregular periods. 2-3 days of periods with 4 more days of spotting is normal.
                </span>
              </div>
            </div>
            <div className="assessment__desc__one">
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  ...
                  Your symptoms show that you have these regular moods generally including stressed, sad, overwhelmed, and angry. You have been feeling extreme <b>mood swings</b> from sadness to happiness for no apparent reasons. You find it tough to stay motivated and have been feeling <b>chronic fatigue</b>. Your personal, professional and social life is getting impacted. You are showing physical symptoms as well like shortness of breath, trembling fingers, tingling sensations, and <b>anxiousness</b>. <br/><br/>

                  Sexual relationship is seeming painful emotionally, that is something will be addressed together in therapy sessions along with your sleep issues as well.<br/><br/>

                  As a <b>working professional, with less or no physical activity,</b> stress can accumulate more. Give it a breather. <br/><br/>

                  You also have skin issues like pigmentation, dry skin, allergies, chronic acne and sun damage.<br/><br/>

                  You’ve been on <b>medication for sleep and skin</b>. Restyl 0.25 mg and Cyanomycin- 100 mg<br/><br/>

                  Your <b>family history</b> shows blood pressure issues, and diabetes.<br/><br/>

                  You’re now a Pinga supergirl. You’ll have the best of care and lasting lifestyle improvements.<br/><br/> 

                  As next steps, your health advisor will suggest awesome Pinga doctors and wellness experts to get you started first with your mental health solution and then after some progress, will begin with your skin issues consultations. <br/><br/><br/>

                  Kudos! <br/>
                  On having <b>great scalp hair and breast health</b>. They look great! <br/><br/>

                  However, yearly screening and assessment for breast health is a must. Do it with Pinga! 
          ...
          <div className="report__user__overview">
            <span class="Pinga-Patient-ID-01">Pinga Patient ID: 05</span>
            <span class="Phone-8151955277">
              <span class="text-style-1">Phone: </span>
              +91 9833019007
            </span>
