      ...
      <div className="report">
        ...
        <div className="report__mainDiv">
          ...
          <div className="report__user__overview">
            <span class="Pinga-Patient-ID-01">Pinga Patient ID: 08</span>
            ...
            <span class="Email-riakapoorsgmailcom">
              ...
              manaswini.nc_yif22@ashoka.edu.in 
            </span>
          </div>
            ...
            <div className="report__user__details__dessc">
              ...
              <div className="patient__details">
                <div className="patient__name">
                  <div class="Ria-Kapoor">Manaswini</div>
                  <div class="-yrs-She-Her">23 yrs | She/ Her</div>
                </div>
                <div className="patient__body__details">
                  ...
                  <div className="patient__weight">
                    ...
                    <div class="-KG">70 KG</div>
                  </div>
                  <div className="patient__bmi">
                    <div class="BMI" >BMI</div>
                    <div class="NORMAL">OVERWEIGHT</div>
          ...
          <div class="Health-Journey-Plan-for-Ria-Kapoor">
            Health Journey Plan for Manaswini
          </div>
          {steps.map((data, i) => {
            console.log(data);
            return (
            ...
            <div className="health__assessment__heading">
              ...
              <div className="assessment__heading">
                ...
                <span class="Your-Pinga-sexual-and-intimate-health-SA-shows-you-have-irregular-periods-vaginal-burning-and-heavy">
                  <span class="text-style-1">
                  <b>Manaswini</b>, kudos at taking your overall health and wellness Pinga assessment. <br/>
                  Great investment, we make noodles in less than 10 minutes. <br/><br/>
                  We saw you need help now with your <b>sleep issues and chronic illness areas.</b><br/>
                  </span>
            ...
            <div className="assessment__desc__one">
              ...
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  ...
                  we recorded that you primarily have concerns in 4 dimensions of your health - <b>Mental health, sexual + reproductive health which in your scenario is menstrual health and natural circadian sleep cycle. Sleep and nutrition + body weight management.</b> <br/><br/>

                  <i>However we also suggest that we must do an in depth special assessment of your menstrual health.  </i><br/><br/>

                  You face concerns like <b>improper sleep cycle</b>, anxiousness and Obsessive compulsive disorder. You have <b>extremely painful periods</b>. We noticed you mentioned <b>unusual facial hair</b> growth. Which may be due to <b>hormonal imbalance</b> or not following an appropriate lifestyle, we would like to encourage you to assess and rule out possibilities of having chronic illnesses like PCOS and Endometriosis, Pinga has special assessments and A class doctors and wellness experts to solve your concerns with lasting lifestyle improvements.<br/><br/>       
                  ...
                  Your symptoms show that you have these regular moods generally including stressed, sad, overwhelmed, and angry. You find it tough to stay motivated and have been feeling <b>chronic fatigue</b>. Your personal, professional and social life is getting impacted. You are showing physical symptoms as well like <b>shortness of breath, trembling fingers, tingling sensations</b>, and <b>anxiousness</b>.<br/><br/> 

                  About your gorgeous skin, you feel that you have <b>pigmentation</b> and recently noticed <b>acne</b>. You have also noticed <b>excessive facial and body hair</b> which we covered in chronic illness analysis and looks like, you will need a thorough PCOS or a hormonal imbalance check up. <br/><br/>

                  <b>We recorded that you felt lumps in your breasts. Lumps</b> are mostly benign. It’s good that you took notice and did self examination of breasts. However, yearly screening and assessment for breast health is a must. Do it with Pinga! <br/><br/>

                  As a <b>student in a multidisciplinary course</b>, stress can accumulate more. Give it a breather.<br/><br/> 

                  Your <b>family history</b> shows blood pressure concerns, thyroid related concerns and diabetes.
                </span>
              </div>
            </div>
            <div className="assessment__desc__one">
              <div className="assessment__desc__one__data">
                ...
                As next steps, your health advisor will suggest awesome Pinga doctors and wellness experts to get you started first with your sleep solution and then after some progress, will begin with your chronic illnesses related consultations. However, we highly suggest you also try a mental health assessment with us and a therapy session since we noticed you require help there to improve your symptoms.<br/><br/> 
