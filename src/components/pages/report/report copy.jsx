      ...
      <div className="report">
        ...
        <div className="report__mainDiv">
              ...
              <div className="patient__details">
                ...
                <div className="patient__body__details">
                  ...
                  <div className="patient__bmi">
                    ...
                    <div class="NORMAL">18.7 (just about normal)</div>
          ...
          <div class="Health-Journey-Plan-for-Ria-Kapoor">
            Health Journey Plan for Atumita Modie
          </div>
          {steps.map((data, i) => {
            console.log(data);
            return (
            ...
            <div className="assessment__desc__one">
              ...
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  ...
                  we recorded that you primarily have concerns in 3 dimensions of your health - Mental health, skin and appearance and natural circadian sleep cycle.  
                </span>
              </div>
            </div>
            <div className="assessment__desc__one">
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  You face concerns around mental health which comes out as anxiousness, lack of getting proper and timely sleep, and <b>hormonal imbalance</b> or not following appropriate lifestyle, leads to <b>skin issues</b> that you’re facing. 
                  ...
                  Your symptoms show that you have these regular moods generally including stressed, sad, overwhelmed, and angry. You have been feeling extreme <b>mood swings</b> from sadness to happiness for no apparent reasons. You find it tough to stay motivated and have been feeling <b>chronic fatigue</b>. Your personal, professional and social life is getting impacted. You are showing physical symptoms as well like shortness of breath, trembling fingers, tingling sensations, and <b>anxiousness</b>. 

                  Sexual relationship is seeming painful emotionally, that is something will be addressed together in therapy sessions along with your sleep issues as well.

                  As a <b>working professional, with less or no physical activity,</b> stress can accumulate more. Give it a breather. 

                  You also have skin issues like pigmentation, dry skin, allergies, chronic acne and sun damage.

                  You’ve been on <b>medication for sleep and skin</b>. Restyl 0.25 mg and Cyanomycin- 100 mg

                  Your <b>family history</b> shows blood pressure issues, and diabetes.

                  You’re now a Pinga supergirl. You’ll have the best of care and lasting lifestyle improvements. 

                  As next steps, your health advisor will suggest awesome Pinga doctors and wellness experts to get you started first with your mental health solution and then after some progress, will begin with your skin issues consultations. 

                  Kudos! 
                  On having <b>great scalp hair and breast health</b>. They look great! 
