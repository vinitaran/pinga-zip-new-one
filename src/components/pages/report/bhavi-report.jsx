      ...
      <div className="report">
        ...
        <div className="report__mainDiv">
          ...
          <div className="report__user__overview">
            <span class="Pinga-Patient-ID-01">Pinga Patient ID: 07</span>
            ...
            <div className="report__user__details__dessc">
              ...
              <div className="patient__details">
                <div className="patient__name">
                  <div class="Ria-Kapoor">Bhavi</div>
                  <div class="-yrs-She-Her">37 yrs | She/ Her</div>
                </div>
            ...
            <div className="health__assessment__heading">
              ...
              <div className="assessment__heading">
                ...
                <span class="Your-Pinga-sexual-and-intimate-health-SA-shows-you-have-irregular-periods-vaginal-burning-and-heavy">
                  <span class="text-style-1">
                  <b>Bhavi</b>, kudos at taking your overall health and wellness Pinga assessment. <br/>
                  Great investment, we make noodles in less than 10 minutes. <br/><br/>
                  We saw you need help now with sleep and body’s proper resting mechanism<br/>
                  </span>
            ...
            <div className="assessment__desc__one">
              ...
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  ...
                  we recorded that you primarily have concerns in 3 dimensions of your health - <b>Mental health, skin and appearance and your natural circadian sleep cycle. </b><br/><br/>

                  You face concerns around mental health which comes out as extreme emotional volatility, feeling chronic fatigue and lethargy, and <b>feeling low, with bouts of crying.</b><br/><br/> 
                  ...
                  Your symptoms show that you have these regular moods generally including stressed, sad, overwhelmed, and angry. You have been feeling extreme <b>mood swings</b> from sadness to happiness for no apparent reasons. You find it tough to stay motivated and have been feeling <b>chronic fatigue</b>. Your personal, professional and social life is getting impacted. <br/><br/>

                  As a <b>working professional, with less or no physical activity</b>, stress can accumulate more. Give it a breather.<br/><br/> 

                  <b>Vitamin D deficiency</b> can be a root cause of chronic fatigue and mental health challenges. We will recommend you to get an updated test done and share with us for assessment. We will have a look if it has improved after supplements. <br/><br/>

                  You have <b>skin concerns</b> like pigmentation, dry skin, and unknown allergies. White patches which get dark, itchy and dry must be diagnosed. We will send you a <b>specialized assessment</b> and look for the right <b>dermatologist</b> for you if you want us to address your skin concerns. It will <b>help you improve your skin, and identify specific allergies</b> if you have any and tests show you do. Skin rashes may have many possible root causes like urticaria, contact dermatitis, psoriasis. However, a proper diagnosis can be done in your case. You can trust Pinga.  <br/><br/>

                  Your <b>family history</b> shows blood pressure concerns.<br/><br/>
            ...
            <div className="assessment__desc__one">
              <div className="assessment__desc__one__data">
                ...
                Don’t worry, we got your back! <br/>
                  ...
                  As next steps, your health advisor will suggest awesome Pinga doctors and wellness experts to get you started first with your mental health solution and then after some progress, will begin with your skin issues consultations.<br/><br/> 

                  Kudos! <br/>
                  On having <b>great sexual life and relationship and scalp hair</b>. They look great!  
