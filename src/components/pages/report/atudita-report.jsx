            ...
            <div className="patient__health__desc">
              ...
              <div className="patient__health__data">
                ...
                Based on your general health assessment, we understand your goal is to improve your {" "}
                  ...
                  Mental Health, Physical Health & Skin Health
                  </span>
                </span>
              </div>
            </div>
            ...
            <div className="health__assessment__heading">
              ...
              <div className="assessment__heading">
                ...
                <span class="Your-Pinga-sexual-and-intimate-health-SA-shows-you-have-irregular-periods-vaginal-burning-and-heavy">
                  ...
                  Atumita, kudos, on completing your overall health and wellness Pinga assessment. Great investment, we make noodles in less than 10 minutes. Pat yourself for taking out time and take this most valuable step for your own self.
                </span>
              </div>
            </div>
              ...
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  <span class="text-style-1">After in depth analysis, </span>
                    we recorded that you primarily  have <b>mental health concerns</b>. You were previously diagnosed with Bipolar disorder, borderline personality disorder and Post Traumatic Stress disorder. You’ve been taking medication for 4 years. On a second opinion, you got confused since the psychiatrist was not sure if the previous assessments were correct. 
                </span>
              </div>
            </div>
            <div className="assessment__desc__one">
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  <b>Don’t worry, we got your back! </b><br/>
                  As per your General assessment, you also have issues with <b>chronic acne, sleep cycle and pain in right arm, right shoulder, right leg and right lower back</b>. You’re a student with less physical activity. Wrong posture can trigger many issues. You’re an occasional smoker and you drink occasionally. You do strength training and cardio. <br/><br/>

                  You often feel <b>overwhelmed, unwell, stressed and angry</b>. You have been experiencing <b>extreme mood swings</b> without any apparent reasons, you’ve felt sadness and <b>low esteem</b> a lot recently, you’ve also felt guilty and doubted self worth. <b>Sadness</b> and <b>chronic</b> fatigue has made it difficult for you to function in your personal, social and professional life. You feel <b>physical symptoms</b> like shortness of breath, trembling fingers, anxiousness, tingling sensations and nervousness. <br/><br/>

                  You’ve been on <b>antidepressants and anti anxiety medications</b>.<br/><br/>

                  Your <b>family history</b> shows <b>blood pressure issues, thyroid issues such as *Goitre</b> and history of <b>PCOS</b>.<br/><br/>

                  You have recently experienced <b>allergy during summers</b>.<br/><br/>

                  <i>You’re now a Pinga super girl. You’ll have the best of care and lasting lifestyle improvements.</i><br/><br/><br/>

                  Kudos! <br/>
                  On your <b>Sexual health and Menstrual health front</b>, they look great!
                </span>
              </div>
              <div className="assessment__desc__one__image">
