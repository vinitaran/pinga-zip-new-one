  ...
  const steps = [
    ...
    [
      ...
      },
      {
        ...
        desc: "Consultation 1 done. Consultaion 2 scheduled",
        button: true,
        buttonData: "TALK TO HEALTH ADVISOR",
        result: "",
      },
  ...
  const recommendations = [
    {
      ...
      desc: [
        "Flax seeds , two tsf over one week Around one fistful of roasted Makhana Fruits, around 350 GM's per day, mixed variety",
      ],
    },
    {
      name: "Medical Recommendations",
      desc: [
        "Medicine: Syp Menoreg two tsf bd for 15 days",
      ],
    },
    {
      name: "Lab Tests",
      ...
      <div className="report">
        ...
        <div className="report__mainDiv">
          ...
          <div className="report__user__overview">
            <span class="Pinga-Patient-ID-01">Pinga Patient ID: 11</span>
            ...
            <div className="report__user__details__dessc">
              ...
              <div className="patient__details">
                <div className="patient__name">
                  <div class="Ria-Kapoor">Shruti Dastidar</div>
                  <div class="-yrs-She-Her">19 yrs | She/ Her</div>
                </div>
                <div className="patient__body__details">
                  <div className="patient__height">
                    <div class="HEIGHT">HEIGHT</div>
                    <div class="-FT">5.1 FT</div>
                  </div>
                  <div className="patient__weight">
                    <div class="WEIGHT">WEIGHT</div>
                    <div class="-KG">43 KG</div>
                  </div>
                  <div className="patient__bmi">
                    <div class="BMI" >BMI</div>
                    <div class="NORMAL">17.9 (UNDERWEIGHT)</div>
          ...
          <div class="Health-Journey-Plan-for-Ria-Kapoor">
            Health Journey Plan for Shruti Dastidar
          </div>
          {steps.map((data, i) => {
            console.log(data);
            return (
          ...
          <div class="assessment__card">
            <div className="health__assessment__heading">
              ...
              <div className="assessment__heading">
                ...
                <span class="Your-Pinga-sexual-and-intimate-health-SA-shows-you-have-irregular-periods-vaginal-burning-and-heavy">
                  <span class="text-style-1">
                  <b>Shruti</b>,  kudos at taking your overall health and wellness Pinga assessment. <br/>
                  Great investment, we make noodles in less than 10 minutes.  <br/><br/>

                  We saw you need help now with your sexual and intimate health condition which includes menstrual health symptoms like irregular periods, extremely painful periods, and skin concerns.<br/>
                  </span>
            ...
            <div className="assessment__desc__one">
              ...
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  ...
                  we recorded that you primarily have concerns in 4 dimensions of your health - <b>Sexual + reproductive health</b> which in your scenario is <b>menstrual health, breast health screening,</b> possibility of a <b>chronic illness like endometriosis, Mental health, skin concerns</b> and your <b>nutrition and healthy body weight management</b> due to low body mass index which shows a sign of underweight condition. <br/><br/>

                  We suggest that we must do an in depth, specialized assessment of your menstrual health and mental health to correlate and go to the root cause of having a possibility of a lifestyle or chronic condition.  <br/><br/>

                  You have faced concerns like <b>white nipple discharge in march 2022,</b> they came out as drops. Extremely painful periods is a condition called dysmenorrhea. We noticed you <b>faced pain</b> during sexual intercourse. These symptoms may be due to <b>hormonal imbalance</b> or not following an appropriate lifestyle, we would like to encourage you to assess and rule out possibilities of having chronic illnesses like PCOS and Endometriosis.<br/><br/>


                  Pinga has special assessments and A class doctors and wellness experts to solve your concerns with lasting lifestyle improvements. Yearly screening and assessment for breast health is a must. Do it with Pinga!   <br/><br/>    
                  ...
                  Your symptoms show that you have these regular moods generally including stress and overwhelmedness. You find it tough at times to stay motivated and have been feeling <b>low self esteem</b>. Your personal, professional and social life is getting impacted. You are showing physical symptoms as well like <b>shortness of breath, sweating of your palms, sudden waking up from sleep, trembling fingers, tingling sensations</b>, and <b>anxiousness</b>. <br/><br/>

                  About your gorgeous skin, you feel that you have <b>complaints of stretch marks in your butt area and thighs</b>. You have a <b>combination facial skin,</b> concerned about <b>dark circles</b> and are concerned about pigmentation. <br/><br/>

                  As a <b>student in a multidisciplinary course,</b> stress can accumulate more. Give it a breather. <br/><br/>

                  Your <b>family history</b> shows diabetes. <br/><br/>

                  You have taken <b>birth control pills</b> due to painful periods. <br/>
            ...
            <div className="assessment__desc__one">
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                Don’t worry, just summarising your overall health + wellness. You are at the right place now, drop all your worries. We got your back!  <br/><br/>

                As next steps, your health advisor will suggest awesome Pinga doctors and wellness experts to get you started first with your sleep solution and then after some progress, will begin with your chronic illnesses related consultations. However, <b>we highly suggest you also try a mental health assessment with us and a therapy session since we noticed you require help there to improve your symptoms</b>. <br/><br/>

                <b>Kudos! </b><br/>
                On doing regular physical activities like outdoor games and brisk walking. Also, so good to know that you are happy with your sexual life and relationship at the moment! <br/><br/>
          ...
          <div class="assessment__card">
            <div className="health__assessment__heading">
              ...
              <div className="assessment__heading">
                <span class="sexual-intimate-health-special-assessment">
                Specialized assessment for Skin, hair and appearance
                </span>
                <span class="Your-Pinga-sexual-and-intimate-health-SA-shows-you-have-irregular-periods-vaginal-burning-and-heavy">
                  <span class="text-style-1">
            ...
            <div className="assessment__desc__one">
              ...
              <div className="assessment__desc__one__data">
                <span class="-out-of-10-Pinga-users-like-you-have-shown-similar-symptoms-and-have-completely-recovered-after-a-f">
                  ...
                  <b>Shruti</b>, you have no history or occurrences of Allergies, asthma or keloid tendencies. Your alcohol consumption is occasional and you smoke around 3 times a week. You have a combination skin with oily T zone and normal otherwise, generally. You have acne concerns. This assessment will help your doctor to prepare for your session and give you a smart consultation. We recommend a 15 minutes consultation. <b>However, skin and hair issues may be correlated with underlying conditions like chronic illnesses such as Endometriosis, PCOS, etc.</b> Please follow through your other consultations diligently. You are in good hands now! Pinga will help you become a better version of yourself, everyday. <br/> <br/><br/>
          ...
          <div class="doctor__notes">
            <div className="doctor__notes__heading">
              ...
              <div className="doctor__notes__heading__details">
                ...
                Shruti, here’s what your doctor, Shehla observed and
